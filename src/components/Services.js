        ...
        <>
            <section>
                <div className="container-fluid mx-auto px-[5%] lg:px-[15%] py-16">
                            ...
                            <div>
                                <div id="meditation" className="service-item grid lg:grid-cols-2 gap-10 mx-auto items-center justify-center">
                                ...
                                <div id="sleep"className="service-item grid lg:grid-cols-2 gap-10 mx-auto items-center justify-center">
                                ...
                                <div id="stress"className="service-item grid lg:grid-cols-2 gap-10 mx-auto items-center justify-center">
                                    <div className="service-info">
                                ...
                                <div id="Mindfullness" className="service-item grid lg:grid-cols-2 gap-10 mx-auto items-center justify-center">
